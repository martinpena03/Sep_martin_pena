...
--               d:/Sep_martin_pena/Ayudantia_2_Todo_Junto/Ayudantia_2_Todo_Junto.srcs/sources_1/bd/block_design_ayu_2_full/ip/block_design_ayu_2_full_ALU_0_1/block_design_ayu_2_full_ALU_0_1_sim_netlist.vhdl
...
entity block_design_ayu_2_full_ALU_0_1_ALU is
  port (
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of block_design_ayu_2_full_ALU_0_1_ALU : entity is "ALU";
end block_design_ayu_2_full_ALU_0_1_ALU;

architecture STRUCTURE of block_design_ayu_2_full_ALU_0_1_ALU is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity block_design_ayu_2_full_ALU_0_1 is
  port (
    clk : in STD_LOGIC;
    a : in STD_LOGIC_VECTOR ( 3 downto 0 );
    b : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of block_design_ayu_2_full_ALU_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of block_design_ayu_2_full_ALU_0_1 : entity is "block_design_ayu_2_full_ALU_0_1,ALU,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of block_design_ayu_2_full_ALU_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of block_design_ayu_2_full_ALU_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of block_design_ayu_2_full_ALU_0_1 : entity is "ALU,Vivado 2020.1";
end block_design_ayu_2_full_ALU_0_1;

architecture STRUCTURE of block_design_ayu_2_full_ALU_0_1 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, INSERT_VIP 0";
begin
U0: entity work.block_design_ayu_2_full_ALU_0_1_ALU
     port map (
