...
#
# Generated by export_simulation on Thu Aug 20 21:54:26 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './block_design_ayu_2_full.sh' script.

./block_design_ayu_2_full.sh -reset_run
...
./block_design_ayu_2_full.sh -noclean_files

For more information on the script, please type './block_design_ayu_2_full.sh -help'.
