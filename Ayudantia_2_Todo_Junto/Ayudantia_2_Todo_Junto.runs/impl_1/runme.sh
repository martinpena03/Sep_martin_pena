...
HD_PWD='D:/Sep_martin_pena/Ayudantia_2_Todo_Junto/Ayudantia_2_Todo_Junto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_ayu_2_full_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block_design_ayu_2_full_wrapper.tcl -notrace
