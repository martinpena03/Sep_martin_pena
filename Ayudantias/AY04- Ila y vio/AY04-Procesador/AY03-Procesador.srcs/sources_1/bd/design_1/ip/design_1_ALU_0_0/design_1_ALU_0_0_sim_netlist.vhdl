...
--               vio/AY04-Procesador/AY03-Procesador.srcs/sources_1/bd/design_1/ip/design_1_ALU_0_0/design_1_ALU_0_0_sim_netlist.vhdl}
...
architecture STRUCTURE of design_1_ALU_0_0_ALU is
  ...
  signal \result[3]_i_27_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \result[0]_i_10\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \result[0]_i_11\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \result[0]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \result[0]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \result[1]_i_7\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \result[2]_i_8\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \result[2]_i_9\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \result[3]_i_10\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \result[3]_i_11\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \result[3]_i_21\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \result[3]_i_23\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \result[3]_i_7\ : label is "soft_lutpair1";
begin
...
\result[0]_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4D004400"
    )
        port map (
...
\result[0]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DDFDCCDC"
    )
        port map (
...
\result[0]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\result[3]_i_14\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      I0 => \result[3]_i_20_n_0\,
      I1 => \result[3]_i_21_n_0\,
      I2 => \b_r_reg_n_0_[3]\,
...
\result[3]_i_16\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7888"
    )
        port map (
...
\result[3]_i_17\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\result[3]_i_20\: unisim.vcomponents.LUT6
    generic map(
...
\result[3]_i_21\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"87777888"
    )
        port map (
...
\result[3]_i_24\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAA6AAAAAA6566"
    )
        port map (
      I0 => p_0_in(2),
      I1 => \b_r_reg_n_0_[1]\,
...
\result[3]_i_26\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"55595555559A5599"
    )
        port map (
      I0 => p_0_in(2),
      I1 => \b_r_reg_n_0_[1]\,
...
\result[3]_i_27\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"599AAAAA5959AAAA"
    )
        port map (
      I0 => p_0_in(2),
      I1 => \b_r_reg_n_0_[1]\,
...
\result_reg[0]_i_5\: unisim.vcomponents.MUXF8
     port map (
      I0 => \result_reg[0]_i_8_n_0\,
      I1 => \result_reg[0]_i_9_n_0\,
      O => \result_reg[0]_i_5_n_0\,
      S => \b_r_reg_n_0_[3]\
    );
\result_reg[0]_i_8\: unisim.vcomponents.MUXF7
     port map (
...
\result_reg[0]_i_9\: unisim.vcomponents.MUXF7
     port map (
...
\result_reg[3]_i_18\: unisim.vcomponents.MUXF7
     port map (
...
\result_reg[3]_i_19\: unisim.vcomponents.MUXF7
     port map (
      I0 => \result[3]_i_26_n_0\,
      I1 => \result[3]_i_27_n_0\,
...
\result_reg[3]_i_8\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \result[3]_i_12_n_0\,
      DI(1) => \result[3]_i_13_n_0\,
      DI(0) => '0',
      O(3 downto 0) => result0(3 downto 0),
      S(3) => \result[3]_i_14_n_0\,
      S(2) => \result[3]_i_15_n_0\,
      S(1) => \result[3]_i_16_n_0\,
      S(0) => \result[3]_i_17_n_0\
    );
\result_reg[3]_i_9\: unisim.vcomponents.MUXF8
     port map (
      I0 => \result_reg[3]_i_18_n_0\,
      I1 => \result_reg[3]_i_19_n_0\,
