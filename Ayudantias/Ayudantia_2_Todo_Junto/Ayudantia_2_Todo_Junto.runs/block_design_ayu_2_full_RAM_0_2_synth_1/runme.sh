...
HD_PWD='D:/Sep_martin_pena/Ayudantia_2_Todo_Junto/Ayudantia_2_Todo_Junto.runs/block_design_ayu_2_full_RAM_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_ayu_2_full_RAM_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_ayu_2_full_RAM_0_2.tcl
