...
HD_PWD='D:/Sep_martin_pena/ac_4_mp/ac_4_mp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ac4_reloj.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ac4_reloj.tcl -notrace
