...
HD_PWD='D:/Sep_martin_pena/ac_4_mp/ac_4_mp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ac4_reloj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ac4_reloj.tcl
